...
public class AppDbContext : IdentityDbContext<User>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Billboard>().HasKey(b => b.Id);
        ...
        modelBuilder.Entity<Vendor>().HasData(
            new Vendor
            {
                ...
                VendorType = VendorType.Billboard,
                CreatedAt = DateTimeOffset.UtcNow,
                UpdatedAt = DateTimeOffset.UtcNow,
            },
            new Vendor
        ...
        modelBuilder.Entity<IdentityUserRole<string>>().HasData(
            new IdentityUserRole<string> { UserId = "admin_id", RoleId = "C7D92975-6187-4A4A-AA7A-2CDE79566E27" },
            new IdentityUserRole<string> { UserId = "user_id_1", RoleId = "8E4D3983-F718-4A22-AA52-3C59BCA7ABA4" },
            new IdentityUserRole<string> { UserId = "user_id_2", RoleId = "8E4D3983-F718-4A22-AA52-3C59BCA7ABA4" },
            new IdentityUserRole<string> { UserId = "user_id_3", RoleId = "8E4D3983-F718-4A22-AA52-3C59BCA7ABA4" },
            new IdentityUserRole<string> { UserId = "user_id_4", RoleId = "8E4D3983-F718-4A22-AA52-3C59BCA7ABA4" },
            new IdentityUserRole<string> { UserId = "user_id_5", RoleId = "588731E6-8914-4A5F-8385-7218ED3241E1" },
            new IdentityUserRole<string> { UserId = "user_id_6", RoleId = "588731E6-8914-4A5F-8385-7218ED3241E1" },
            new IdentityUserRole<string> { UserId = "user_id_7", RoleId = "588731E6-8914-4A5F-8385-7218ED3241E1" }
        );
    }
